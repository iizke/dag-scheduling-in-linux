...
int dsm_remove_mpitask(int dagq_id, int rank);
int dsm_add_mpi_connection(int dagq_id, int from_rank, int to_rank);
int dsm_remove_mpi_connection(int dagq_id, int from_rank, int to_rank);
